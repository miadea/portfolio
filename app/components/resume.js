  ...
  render() {
    ...
    return (
      <div className="resume-page">
        <a className="download" href="./public/resume2.pdf" download >Download</a>
        <PDF className="pdf" file="./public/resume2.pdf" onDocumentComplete={this.onDocumentComplete} onPageComplete={this.onPageComplete} page={this.state.page} />
        {nextButton}
        {backButton}
      </div>
    );
